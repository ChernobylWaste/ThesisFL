...
DATASET_PATHS = {
    0:"/home/mbc/thesissatria/Dataset/CICIoT2023 rows 1814248 _39%, 38%, 38%, 60%, 35%, 30%, 3%, 3%, 3%.csv",
    1:"/home/mbc/thesissatria/Dataset/CICIoT2023 rows 1814248_1%, 3%, 4%, 80%, 80%, 90%, 90%, 90%, 100%.csv"
}
...
def load_data(partition_id, num_partitions):
    ...
    # Selected Feature dari Feature Importance XGBoost
    selected_features = [
...
def load_model():
    ...
    model = Sequential([
        Dense(units=128, activation='relu', input_dim=20),
